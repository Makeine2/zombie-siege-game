...
public class TowerObject : MonoBehaviour
{
    ...
    private void Start()
    {
        InitInfo(GameDataMgr.Instance.towerInfoList[7]);
    }
    /// <summary>
    /// 初始化炮台相关数据
    /// </summary>
    ...
    void Update()
    {
        ...
        if (info.type == 1)
        {
            ...
            {
                targetObj = GameLeveMgr.Instance.FindMonster(this.transform.position, info.atkRange);
            }
        ...
        {
            targetObjs = GameLeveMgr.Instance.FindMonsters(this.transform.position, info.atkRange);
